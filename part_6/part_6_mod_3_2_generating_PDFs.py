...
# of them: ReportLab https://www.reportlab.com/opensource/

# ReportLab has a lot of different features for creating PDF documents. We'll cover just the basics here, and give you
# pointers for more information at the end.
...
# add some content to it! We'll create a title, some text in paragraphs, and some charts and images. For that, we're
...
# object now contains a default "sample" style. It’s like a dictionary of different style settings. If you've ever
# written HTML, the style settings will look familiar. For example h1 represents the style for the first level of
...
# Okay, now let's take a look at the PDF: open generate_PDF_1.png


"""Adding Tables to our PDFs"""
# Up to now, we've generated an extra simple PDF file, that just includes a title.
#
# Let's spice this up by adding a Table. To make a Table object, we need our data to be in a list-of-lists, sometimes
# called a two-dimensional array. We have our inventory of fruit in a dictionary. How can we convert a dictionary into
# a list-of-lists?
...
# And this is how the generated report looks now: open generate_PDF_2.png

# Okay, it worked! It's not very easy to read, though. Maybe we should add some style to report_table. For our example,
# we'll add a border around all the cells in our table, and move the table over to the left. TableStyle definitions
# can get pretty complicated, so feel free to take a look at the documentation for a more complete idea of what’s
# possible.
...
# graphical. What could be better than a fruit pie (graph)?! We’re going to need to use the Drawing Flowable class to
# create a Pie chart.
...
# The Pie object isn’t Flowable, but it can be placed inside a Flowable Drawing.
