...
"""
# As we've mentioned, for the project in this module, you'll use Python Imaging Library to process a bunch of images.
...
# There's a ton more that you can do with the PIL library. Have a look at the docs
