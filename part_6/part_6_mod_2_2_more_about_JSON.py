...
# And as you’ve probably noticed, JSON elements are always comma-delimited. With these basics under your belt, you could
# create valid JSON by hand, and edit examples of JSON that you encounter. Except we don't really want to do that, since
# it's clunky and we’re bound to make a ton of errors! Instead, let’s use the json library that does all the heavy
# lifting for us.
...
# able to automatically serialize them as JSON. Take a look at this table
# https://docs.python.org/3/library/json.html#py-to-json-table
# to see in detail how Python objects are converted into JSON elements.
