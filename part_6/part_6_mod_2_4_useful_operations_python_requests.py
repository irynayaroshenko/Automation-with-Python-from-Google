...
# First, how do we know if a request we made got a successful response? You can check out the value of Response.ok
# https://requests.readthedocs.io/en/master/api/#requests.Response.ok which will be True if the response was good, and
# False if it wasn't.
...
# If the boolean isn’t specific enough for your needs, you can get the HTTP response code
# https://www.iana.org/assignments/http-status-codes/http-status-codes.xhtml
#  that was returned by looking at Response.status_code
...
# But you don't really need to do that. 'Requests' has us covered here, too! We can use the Response.raise_for_status()
