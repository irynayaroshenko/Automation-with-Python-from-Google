"""
The create_python_script function creates a new python script in the current directory, adds the line of comments to it
...
#         file.write(comments)
#     filesize = os.path.getsize(filename)  # noqa
#     return (filesize)
#
#
...
"""
The new_directory function creates a new directory inside the current working directory, then creates a new empty file
inside the new directory, and returns the list of files in that directory. Fill in the gaps to create a file "script.py"
...
#     dt_time = str(datetime.datetime.fromtimestamp(timestamp))
#     # Return just the date portion
#     # Hint: how many characters are in “yyyy-mm-dd”?
#     return "{}".format(dt_time[:10])
#
#
...
Remember that '..' is a relative path alias that means "go up to the parent directory". Fill in the gaps to complete
this function."""
import os
