...
# student-04-c958860afa12@puppet:~$ echo $PATH
...
# Output:
# student-04-c958860afa12@puppet:~$ ls /
...
# Output:
# student-04-c958860afa12@puppet:/etc/puppet/code/environments/production/modules/profile/manifests$ cat init.pp
# class profile {
...
# Output:
# student-04-c958860afa12@puppet:/etc/puppet/code/environments/production/modules/profile/manifests$ sudo puppet agent -v --test
# Info: Using configured environment 'production'
# Info: Retrieving pluginfacts
# Info: Retrieving plugin
# Info: Retrieving locales
# Info: Caching catalog for puppet.us-west4-c.c.qwiklabs-gcp-00-9c8d64c88ebd.internal
# Info: Applying configuration version '1691400556'
# Notice: /Stage[main]/Profile/File[/etc/profile.d/append-path.sh]/content:
# --- /etc/profile.d/append-path.sh       2023-08-07 09:19:26.825734205 +0000
# +++ /tmp/puppet-file20230807-3280-je6sp7        2023-08-07 09:29:16.626789208 +0000
# @@ -1 +1 @@
# -PATH=/java/bin
# +PATH=$PATH:/java/bin
#
